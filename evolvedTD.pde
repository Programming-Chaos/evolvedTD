...
void beginContact(Contact cp) { // called when two box2d objects collide
  ...
  if ((o1.getClass() == creature.class && o2.getClass() == food.class) || (o1.getClass() == food.class && o2.getClass() == creature.class)) {// check the class of the objects and respond accordingly
    // creatures grab food
  ...
  if ((o1.getClass() == creature.class && o2.getClass() == projectile.class) || (o1.getClass() == projectile.class && o2.getClass() == creature.class)) {// check the class of the objects and respond accordingly
